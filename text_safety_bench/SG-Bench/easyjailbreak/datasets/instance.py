...
class Instance:
    def __init__(self, *, query:str=None, jailbreak_prompt:str=None, reference_responses:'List[str]'=None, target_responses:'List[str]'=None, history_list=[], multi_turn_queries=[], eval_results:list=None, parents:list=None, children:list=None, attack_attrs=None, **kwargs):
        """
        ...
        self.multi_turn_queries = multi_turn_queries
    ...
    def copy(self):
        ...
        new_Instance = Instance(
            ...
            multi_turn_queries = self.multi_turn_queries.copy(),
